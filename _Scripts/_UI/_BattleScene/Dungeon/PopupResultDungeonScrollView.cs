...
{
    public class PopupResultDungeonScrollView : MonoBehaviour, IEnhancedScrollerDelegate
    {
         [SerializeField] private PopupResultVictoryCellVeiw prefabCellView;
        [Space(20)]
        ...
        {
            PopupResultVictoryCellVeiw cellView = scroller.GetCellView(prefabCellView) as PopupResultVictoryCellVeiw;
