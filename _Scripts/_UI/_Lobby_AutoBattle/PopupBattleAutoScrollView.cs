...
namespace ProjectM
{
    public class PopupBattleAutoScrollView : MonoBehaviour, IEnhancedScrollerDelegate
    {
        [SerializeField] private PopupBattleAutoCellView prefabCellView;
        [Space(20)]
        ...
        private void Start()
        {
            ...
            // enhancedScroller.cellViewVisibilityChanged += SetCellViewSize;
            //
            // HorizontalOrVerticalLayoutGroup layoutGroup = enhancedScroller.Container.GetComponent<HorizontalOrVerticalLayoutGroup>();
            // if (layoutGroup)
            // {
        ...
        {
            PopupBattleAutoCellView cellView = scroller.GetCellView(prefabCellView) as PopupBattleAutoCellView;
