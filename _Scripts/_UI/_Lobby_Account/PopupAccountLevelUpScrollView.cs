...
namespace ProjectM
{
    public class PopupAccountLevelUpScrollView : MonoBehaviour, IEnhancedScrollerDelegate
    {
        [SerializeField] private PopupAccountLevelUpCellView prefabCellView;
        [Space(20)]
        ...
        {
            PopupAccountLevelUpCellView cellView = scroller.GetCellView(prefabCellView) as PopupAccountLevelUpCellView;
