...
{
    public class ProjectileExplosionState : SkillState, IState
    {
        public ProjectileExplosionState(UnitBase unit, SkillAI data, StateMachine stateMachine)
        {
            this.caster = unit;
            this.data = data;
            this.stateMachine = stateMachine;
            Init();
            // PoolManager.Instance.CreatePool(data.ObjectResource, 10);
        }
